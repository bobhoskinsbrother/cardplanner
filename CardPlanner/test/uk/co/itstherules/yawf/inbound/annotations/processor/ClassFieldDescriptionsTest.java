...
public class ClassFieldDescriptionsTest {
    ...
    @Test
    public void stopHeirarchyHalfway() {
...
class SimpleTestClass {
    ...
    @QueryKey("koi")
    private String freud;
}

class SimpleHeirarchyTestClass extends SimpleTestClass {
    @SuppressWarnings("unused")
    @QueryKey("poi")
    private String royal;
}

class TopHeirarchyTestClass {
    @SuppressWarnings("unused")
    @QueryKey("oik")
    private String royal;
}
...
@QueryKeyRoot
class MiddleHeirarchyTestClass extends TopHeirarchyTestClass {
    @SuppressWarnings("unused")
    @QueryKey("koi")
    private String loyal;
}

class BottomHeirarchyTestClass extends MiddleHeirarchyTestClass {
    @SuppressWarnings("unused")
    @QueryKey("poi")
