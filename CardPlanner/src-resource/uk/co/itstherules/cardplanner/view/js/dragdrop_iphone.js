...
var Droppables = {
  ...
  fire: function(event, element) {
    ...
    Position.prepare();
   	var pointer = Draggables.pointerXY(event);
...
var Draggables = {
  ...
  pointerXY: function(event) {
	  if(Draggables.supportsTouch && event.touches) {
		  if(!event.touches[0]) {
			  var reply = [event.pageX, event.pageY];
			  reply.x = event.pageX;
			  reply.y = event.pageY;
			  return reply;
		  }
...
var Sortable = {
  ...
  create: function(element) {
    ...
    // change options for the draggables
    ...
    // change options for the droppables
