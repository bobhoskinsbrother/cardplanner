    ...
    handlers: {
        ...
        unmark: (function() {
            ...
            var PROPERTIES_ATTRIBUTES_MAP = (function() {
                var el = document.createElement('div'), isBuggy = false, propName = '_countedByPrototype', value = 'x'
                el[propName] = value;
...
var Position = {
    ...
    windowSize: function(windoh) {
        var array = [];
        windoh = windoh ? windoh : window;
        array.width = array[0] = windoh.innerWidth || (windoh.document.documentElement.clientWidth || windoh.document.body.clientWidth);
        array.height = array[1] = windoh.innerHeight || (windoh.document.documentElement.clientHeight || windoh.document.body.clientHeight);
        return array;
    },
