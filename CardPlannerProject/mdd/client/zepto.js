...
(function($){
  ...
  // *Arguments:*
  //
  //     options â€” object that configure the request,
  //               see avaliable options below
  //
  // *Avaliable options:*
  //
  //     url     â€” url to which the request is sent
  //     success â€” callback that is executed if the request succeeds
  //     error   â€” callback that is executed if the server drops error
  //     context â€” in which context to execute the callbacks in
  //
  // *Example:*
  //
  //     $.ajaxJSONP({
  ...
  // *Avaliable options:*
  //
  //     type ('GET')          â€” type of request GET / POST
  //     url (window.location) â€” url to which the request is sent
  //     data                  â€” data to send to server,
  //                             can be string or object
  //     dataType ('json')     â€” what response type you accept from
  //                             the server:
  //                             'json', 'xml', 'html', or 'text'
  //     timeout (0)           â€” request timeout
  //     beforeSend            â€” callback that is executed before
  //                             request send
  //     complete              â€” callback that is executed on request
  //                             complete (both: error and success)
  //     success               â€” callback that is executed if
  //                             the request succeeds
  //     error                 â€” callback that is executed if
  //                             the server drops error
  //     context               â€” in which context to execute the
  //                             callbacks in
  //
  // *Example:*
  //
  ...
  //
  //     url        â€” url to which the request is sent
  //     [data]     â€” data to send to server, can be string or object
  //     [success]  â€” callback that is executed if the request succeeds
  //     [dataType] â€” type of expected response
  //                  'json', 'xml', 'html', or 'text'
  //
  // *Example:*
  //
  ...
  // *Arguments:*
  //
  //     obj â€” object to serialize
  //     [traditional] â€” perform shallow serialization
  //
  // *Example:*
  //
