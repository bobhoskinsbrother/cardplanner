...
public final class CachedInstance {
	...
	public enum Identities implements Identity {
		...
		GOD_PERMISSION("455d06b4-99a8-414d-aa11-ecdc2758bd37", PermissionModel.class),

		BASE_GROUP("031a3737-86af-4a45-a66f-31c6f13d9377", GroupModel.class),
		...
		INVISIBLE_GROUP("d8c3a7ba-917a-49ee-a1cf-1bebf3575b96", GroupModel.class),
	...
	public void initialise(ObjectCache objectCache) {
		...
		if(configurationModel.getFirstRun()) {
			...
			instances.persistIfNotExists(Identities.GOD_PERMISSION);
			
			instances.persistIfNotExists(Identities.BASE_GROUP);
			...
			instances.persistIfNotExists(Identities.INVISIBLE_GROUP);
