...
public class CachedInstanceTest {
	...
	public void checkThatDefaultObjectsAreStored() {
		...
		PermissionModel permissionModel = findFirst(PermissionModel.class, objects);
		assertThat(permissionModel.getIdentity(), is(Identities.GOD_PERMISSION.getIdentity()));
		...
		assertThat(objects, contains(2, GroupModel.class));
